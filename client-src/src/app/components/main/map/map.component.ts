...
export class MapComponent implements OnInit {
  ...
  public customers = [];
  public factories = [];
  constructor(private _customerService:CustomerService ,private _branchService:BranchService, private _advertismentService:AdvertismentService, private _competitorService:CompetitorService, private _factoryService:FactoryService) {
